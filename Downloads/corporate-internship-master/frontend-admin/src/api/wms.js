...
// 查询仓库零件可用库存（用于出库单创建）
export function getWarehousePartStock(warehouseCode) {
    return http.get(`/wms/warehouse/${warehouseCode}/part-stock`)
}
...
// ==================== FIFO库存查询 ====================
export function getFifoInventoryList(partCode, warehouseCode) {
    const params = { partCode }
    if (warehouseCode) {
        params.warehouseCode = warehouseCode
    }
    return http.get('/wms/inventory/fifo-list', { params })
}

// ==================== 转包功能 ====================
export function getTransferOrderList(params) {
    return http.get('/wms/transfer/list', { params })
}

export function splitKanban(data) {
    return http.post('/wms/transfer/split', data)
}

export function mergeKanban(data) {
    return http.post('/wms/transfer/merge', data)
}

// ==================== 封存/解封功能 ====================
export function sealKanban(data) {
    return http.post('/wms/kanban/seal', data)
}

export function unsealKanban(data) {
    return http.post('/wms/kanban/unseal', data)
}

export function getSealHistory(params) {
    return http.get('/wms/kanban/seal-history', { params })
}
